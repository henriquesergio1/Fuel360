...
// Logo Gota/Combustível - Redesigned for Corporate Blue
export const FuelLogo: React.FC<IconProps> = ({ className = 'w-10 h-10' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className} fill="none">
    <defs>
      <linearGradient id="blueGradient" x1="20" y1="20" x2="80" y2="80" gradientUnits="userSpaceOnUse">
        <stop stopColor="#2563eb" /> {/* blue-600 */}
        <stop offset="1" stopColor="#0ea5e9" /> {/* sky-500 */}
      </linearGradient>
    </defs>
    <circle cx="50" cy="50" r="45" className="text-white" fill="currentColor" stroke="#e2e8f0" strokeWidth="2" />
    <path d="M50 15 Q85 60 50 88 Q15 60 50 15 Z" fill="url(#blueGradient)" stroke="white" strokeWidth="1.5" />
    <path d="M50 15 Q68 50 50 72" stroke="white" strokeWidth="1.5" strokeOpacity="0.4" fill="none" />
  </svg>
);
